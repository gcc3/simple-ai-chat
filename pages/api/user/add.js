...
export default async function (req, res) {
  ...
  if (process.env.USE_EMAIL == "true") {
    ...
    + "3. Forgot your password? Use the command `:user reset pass [username] [email]` to reset your password 🆘." + "<br>"
    + "4. To access the documentation and confirm usage: click the dot (•) in the screen corner 📄." + "<br>"
    + "5. Use the ← and → arrow keys to navigate between logs 🗂️." + "<br>"
    + "6. Shortcut: `Control + |` for split-screen mode, `Control + F11` to switch to fullscreen mode 🖥️." + "<br>"
    + "7. List history sessions with `:ls`, switch sessions with `:attach [session_id]`. 📌." + "<br>"
    + "8. Change theme: use `:theme [light|dark|terminal]` 🌈." + "<br>"
    ...
    + "<br>"
    + "- Feeling generous? Invite friends to join, and both of you will receive 100K award tokens! 💌" + "<br>"
    + "How to invite: " + "<br>"
