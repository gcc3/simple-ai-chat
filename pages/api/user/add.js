...
export default async function (req, res) {
  ...
  if (process.env.USE_EMAIL == "true") {
    ...
    + "<br>"
    + "* Please do not register multiple accounts to avoid having your account suspended." + "<br>"
    * "* It may display incorrect or harmful information, and it's not intended to give professional advice, including legal, financial, and medical advice. Do not rely on the answer without doing your own independent research." + "<br>"
    + "<br>"
    + "Thanks," + "<br>"
