...
export default async function (req, res) {
  ...
  if (process.env.USE_EMAIL == "true") {
    ...
    + "For example, `:user add aaa bbb@ccc.zz ********`" + "<br>"
    ...
    + "<br>"
    + "- Feel generous? Invite friends using the command `:invite [email]` and both of you will recieve 100K award tokens! 💌" + "<br>"
    + "How to invite: " + "<br>"
    + "Invite a friend to join, register as a user. After they click the invitation link below, both of you will be granted 100K tokens for usage." + "<br>"
