...
export function setTheme(theme) {
  ...
  if (theme == "light") {
    ...
    document.documentElement.style.setProperty("--button-selected-background-color", "rgba(215, 215, 215, 0.4)");
  ...
  if (theme == "dark") {
    ...
    document.documentElement.style.setProperty("--button-selected-background-color", "rgba(215, 215, 215, 0.2)");
  ...
  if (theme == "terminal") {
    ...
    document.documentElement.style.setProperty("--button-selected-background-color", "rgba(0, 100, 0, 0.3)");
