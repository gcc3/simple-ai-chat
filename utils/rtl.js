export function setRtl(rtl) {
  if (rtl) {
    ...
    document.documentElement.style.setProperty("--submit-rtl-left-offset", "calc(50% + 20px)");
    ...
    document.documentElement.style.setProperty("--nav-rtl-left-margin", "8px");
  } else {
    document.dir = "ltr";
    document.documentElement.style.setProperty("--submit-rtl-right-offset", "calc(50% + 20px)");
    ...
    document.documentElement.style.setProperty("--nav-rtl-right-margin", "8px");
