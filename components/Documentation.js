...
const Documentation = ({ country }) => {
  ...
  const shortcuts = [
    ...
    { action: t("Previous session."), shortcut: "⌃↑", condition: t("Unfocused from the input area or input box is empty. Not generating.") },
    { action: t("Next session."), shortcut: "⌃↓", condition: t("Unfocused from the input area or input box is empty. Not generating.") },
    { action: t("Previous log (same session)."), shortcut: "← or K", condition: t("Unfocused from the input area or input box is empty. Not generating.") },
    { action: t("Next log (same session)."), shortcut: "→ or J", condition: t("Unfocused from the input area or input box is empty. Not generating.") },
