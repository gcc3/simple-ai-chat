...
const Documentation = ({ country }) => {
  ...
  const shortcuts = [
    ...
    { action: t("Command autocomplete."), shortcut: "Tab", condition: t("Focused on the input area. Input commands `:role use`, `:store use`, `:node use`, `:theme` and type the starts characters of the value.") },
