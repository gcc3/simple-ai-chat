...
const Documentation = ({ country }) => {
  ...
  const settings = [
    ...
    { name: "Role", key: "role", example: "___", description: "" },
    { name: "Store", key: "store", example: "___", description: "" },
    { name: "Node", key: "node", example: "___", description: "" },
    ...
    { name: "Location", key: "location", example: "___", description: "" },
