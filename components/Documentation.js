...
const Documentation = ({ country }) => {
  ...
  const shortcuts = [
    ...
    { action: t("Clear the input."), shortcut: "ESC", condition: t("Focused on the input area. Input area not empty.xxx") },
    { action: t("Unfocus from the input box.xxx"), shortcut: "ESC", condition: t("Focused on the input area. Input area is empty/cleared.xxx") },
    { action: t("Repeat last input."), shortcut: "Tab", condition: t("Focused on the input area. Input area is empty/cleared.xxx") },
    { action: t("Command autocomplete."), shortcut: "Tab", condition: t("Focused on the input area. Input commands `:use`, `:function use`, `:role use`, `:store use`, `:node use`, `:theme`, `:lang use`, `:user set` and type the starts characters of the value.xxx") },
    ...
    { action: t("Previous command."), shortcut: "↑", condition: t("Focus on the input area. The current input is starts with `:`. Has a previous command in command history.xxx") },
    { action: t("Next command."), shortcut: "↓", condition: t("Focus on the input area. The current input is starts with `:`. Has a next command in command history.xxx") },
