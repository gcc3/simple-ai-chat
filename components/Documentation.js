...
const Documentation = ({ country }) => {
  ...
  const shortcuts = [
    ...
    { action: t("Command autocomplete."), shortcut: "Tab", condition: t("Focused on the input area. Input commands `:use`, `:function use`, `:role use`, `:store use`, `:node use`, `:theme`, `:lang use`, `:user set` and type the starts characters of the value.") },
    { action: t("Previous session."), shortcut: "↑ or H", condition: t("Unfocused from the input area or input box is empty (for ↑). Not generating.") },
    { action: t("Next session."), shortcut: "↓ or L", condition: t("Unfocused from the input area or input box is empty (for ↓). Not generating.") },
    { action: t("Previous log (same session)."), shortcut: "← or K", condition: t("Unfocused from the input area or input box is empty (for ←). Not generating.") },
    { action: t("Next log (same session)."), shortcut: "→ or J", condition: t("Unfocused from the input area or input box is empty (for →). Not generating.") },
    { action: t("Previous command."), shortcut: "↑", condition: t("Focus on the input area. The current input is starts with `:`. Has a previous command in command history.") },
    { action: t("Next command."), shortcut: "↓", condition: t("Focus on the input area. The current input is starts with `:`. Has a next command in command history.") },
