...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", command: ":store init [engine]", short_description: "Initialize a data store.", description: "Initialize a data store with database engine, supported engines: vectara, mysql. Engine name should be enclosed in double quotes." },
