...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", annotation: "", command: ":use [name]", options: "", short_description: "Use a model, function, node, store or role, or any other resource.", description: "Use a model, function, node, store or role, or any other resource. Same as `:function use`, `:role use`, `:store use` or `:node use`, just for reducing some typing. If a function, node, store or role has same name, will first try to find function, then node, then store, then role." },
