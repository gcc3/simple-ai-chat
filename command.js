...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", annotation: "", command: ":split", short_description: "Short for `:fullscreen split`.", description: "Same as command `:fullscreen split` but shorter. Use fullscreen split mode, to split screen left and right. Or use off to turn fullscreen off. Fullscreen split mode will makes easier to input data and review output, especially when dealing with lengthy responses." },
    { id: "", title: "", annotation: "", command: ":theme [light|dark|terminal]", short_description: "Change color theme.", description: "" },
    { id: "", title: "", annotation: "", command: ":lang [ls|list]", short_description: "List all languages.", description: "List all available language codes." },
    { id: "", title: "", annotation: "", command: ":lang use [language_code]", short_description: "Set language.", description: "Set language. This language settings is both for page UI, voice and the text generation. The language code should include country code too, example: `fr-FR`." },
    ...
    { id: "", title: "", annotation: "", command: ":function [use|unuse] [name]", short_description: "Use or unuse a function.", description: "Use or unuse a function for function calling. [name] can be function name or function's friendly name." },
    ...
    { id: "commands-store", title: "Data Store", annotation: "", command: ":search [text]", short_description: "Search from data store(s).", description: "Search to get inforamtion from the current data store with nature language." },
    ...
    { id: "commands-node", title: "Node (Node AI)", annotation: "", command: ":generate [prompt]", short_description: "Generate from node.", description: "Generate from the current node (Node AI)." },
    { id: "", title: "", annotation: "", command: ":node [name?]", short_description: "Show node detail.", description: "The node name is optional. If no name is input, it will return the current node details, the prompt must be enclosed in double quotes." },
    ...
    { id: "", title: "", annotation: "", command: ":user [info?]", short_description: "Get logged-in user info and settings.", description: "Get logged-in user info and settings." },
