...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", annotation: "", command: ":lang use [language_code]", short_description: "Set language.", description: "Set language. This language settings is both for voice and the page UI." },
    ...
    { id: "", title: "", annotation: "", command: ":use [name]", short_description: "Use a node, store or role.", description: "Use a node, store or role. Same as `:role use`, `:store use` or `:node use`, just for reducing some typing. If a node, store or role has same name, will first try to find node, then store, then role." },
