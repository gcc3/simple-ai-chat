...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", command: ":set [key] [value]", short_description: "Set local setting.", description: "Set local configuration, the key must be one of: session, time, memLength, role, store, node, showStats, stream, speak, voice, lang, locationService, location" },
