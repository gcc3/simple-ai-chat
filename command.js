...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", command: ":stop", short_description: "Stop generating. (⌃c)", description: "Same as in a shell/termianl/console executing command, use control + c to stop generating." },
    { id: "", title: "", command: ":clear", short_description: "Clear output. (⌃r)", description: "Reset output to empty." },
    { id: "", title: "", command: ":reset", short_description: "Clear output and reset session. (⇧⌃r)", description: "Resetting the AI memory will also revert the roles and storage settings to their defaults, since these configurations are stored in the session storage." },
    { id: "", title: "", command: ":fullscreen", short_description: "Use fullscreen mode.", description: "" },
    { id: "", title: "", command: ":fullscreen [split|off]", short_description: "Fullscreen split mode or turn off.", description: "I highly recommend trying the fullscreen split mode, as it makes it easier to input data and review output, especially when dealing with lengthy responses." },
    { id: "", title: "", command: ":theme [light/dark/terminal]", short_description: "Change color theme.", description: "" },
    { id: "", title: "", command: ":function [ls|list]", short_description: "List all supported functions.", description: "To directly call a function, use `!function_name(parameter)`" },
    ...
    { id: "", title: "", command: ":ls", short_description: "List sessions, same as `:session ls`.", description: "List sessions with short user input." },
    ...
    { id: "", title: "", command: ":role [reset]", short_description: "Reset role to empty.", description: "Clear the current role setting." },
    ...
    { id: "commands-user", title: "User", command: ":user add [username] [email] [password?]", short_description: "Create a user.", description: "Email verification is required. Setting a password is optional. If you do not set a password, the system will generate one for you and send it to your email." },
