...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", annotation: "", command: ":store add [engine] [name]", options: "", short_description: "Create a data store.", description: "Create a database with engine and store name. Supported engines: \"vectara\", \"mysql\". Engine and store name must be enclosed in double quotes. Store name can only contain letters, numbers, underscores and hyphens and less than or equals 32 charactors." },
