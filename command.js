...
export function getCommands() {
  const commands = [
    { id: "commands-general", title: "General", command: ":help [command?]", short_description: "Show command help.", description: "Show command help. The command should be enclosed in double quotes." },
    { id: "", title: "", command: ":stop", short_description: "Stop generating. (⌃c)", description: "Stop generating. Same as in a shell, use control + c can stop executing." },
    ...
    { id: "", title: "", command: ":fullscreen [off?]", short_description: "Fullscreen default mode (F11).", description: "Fullscreen default mode, or turn it off" },
    { id: "", title: "", command: ":fullscreen split", short_description: "Fullscreen split mode (⌃|).", description: "Use fullscreen split mode, to split screen left and right. Or use off to turn fullscreen off. Fullscreen split mode will makes easier to input data and review output, especially when dealing with lengthy responses." },
    ...
    { id: "", title: "", command: ":store add [engine] [name]", short_description: "Create a data store.", description: "Create a database with engine and store name. Supported engines: \"vectara\", \"mysql\". Engine and store name must be enclosed in double quotes." },
    { id: "", title: "", command: ":store init [name?]", short_description: "Initialize a data store.", description: "Initialize the current data store. Store name (optional) should be enclosed in double quotes." },
    { id: "", title: "", command: ":store set owner [owner]", short_description: "Change store owner.", description: "" },
    { id: "", title: "", command: ":store set [key] [value]", short_description: "Setup a store settings.", description: "Adjust the values of data store settings. The value must be enclosed in double quates." },
    { id: "", title: "", command: ":store data upload [file]", short_description: "Upload file for indexing.", description: "Upload file for vector database indexing, support .txt, .docx, .pdf files." },
