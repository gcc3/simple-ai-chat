...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", annotation: "", command: ":function [use|unuse] [name]", options: "", short_description: "Use or unuse a function.", description: "Use or unuse a function for function calling. [name] can be function name or function's friendly name." },
    ...
    { id: "", title: "", annotation: "", command: ":store add [engine] [name]", options: "", short_description: "Create a data store.", description: "Create a database with engine and store name. Supported engines: \"vectara\", \"mysql\". Engine and store name must be enclosed in double quotes." },
    ...
    { id: "", title: "", annotation: "", command: ":store data upload [file]", options: "", short_description: "Upload file for indexing.", description: "Upload file for vector database indexing, support .txt, .docx, .pdf files." },
    ...
    { id: "", title: "", annotation: "", command: ":node use [name]", options: "", short_description: "Use a node.", description: "" },
    ...
    { id: "", title: "", annotation: "", command: ":node add [name]", options: "", short_description: "Create a node.", description: "" },
    ...
    { id: "", title: "", annotation: "", command: ":user role [add|set] [role_name] [prompt]", options: "", short_description: "Add a role.", description: "" },
    { id: "", title: "", annotation: "", command: ":user role [del|delete] [role_name]", options: "", short_description: "Delete a role.", description: "" },
