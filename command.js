...
export function getCommands() {
  const commands = [
    ...
    { id: "", title: "", annotation: "", command: ":lang", options: "", short_description: "Show current language.", description: "Show the current language and country-language code." },
    ...
    { id: "", title: "", annotation: "", command: ":set [key] [value]", options: "", short_description: "Set local configurations.", description: "Set session configurations and local configurations, the key must be one of session storage or local storage key, case-insensitive. For values include space(s) must be enclosed in double quotes. Example: `set memlength 0`, this can set the memory to 0 and save a lots of tokens. If you want to use function calling don't set to 0, 1 call = 1 mem, and response also increase 1 mem." },
    { id: "", title: "", annotation: "", command: ":set all", options: "", short_description: "Show local configurations.", description: "Show local configurations and session configurations that saved in browser session storage or local storage." },
    { id: "", title: "", annotation: "", command: ":use [name]", options: "", short_description: "Use a resource.", description: "Use a model, function, node, store or role, or any other resource. Same as `:function use`, `:role use`, `:store use` or `:node use`, just for reducing some typing. If a function, node, store or role has same name, will first try to find function, then node, then store, then role." },
    ...
    { id: "", title: "", annotation: "", command: ":search [text]", options: "", short_description: "Search text from logs.", description: "" },
    ...
    { id: "", title: "", annotation: "", command: ":voice reset", options: "", short_description: "Reset voice.", description: "Reset the voice selection to empty." },
    ...
    { id: "commands-store", title: "Data Store", annotation: "", command: ":store [name?]", options: "", short_description: "Show data store detail.", description: "Show detail of a data store. The store name is optional. If no name is input, it will return the current data store details." },
    ...
    { id: "", title: "", annotation: "", command: ":store search [text]", options: "", short_description: "Search text from data store(s).", description: "Search to get information from the current data store with natural language." },
