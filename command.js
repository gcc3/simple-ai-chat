...
export function getCommands() {
  const commands = [
    ...
    { id: "commands-cli", title: "Exit", annotation: "", command: ":exit", options: "", short_description: "Exit the program.", description: "This command only avalibale in CLI (command-line interface)." },
  ];
  return commands;
}
